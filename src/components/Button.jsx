...
const styles = {
  primary:
    'rounded-full bg-zinc-300 py-2 px-4 text-sm font-semibold text-slate-900 hover:bg-zinc-200 active:bg-zinc-500 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-300/50',
  secondary:
